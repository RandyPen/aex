/* ═══════════════════════════════════════════════════════════
   Mock data for Cetus AEX agents (demo mode)
   ═══════════════════════════════════════════════════════════ */
...
/* ═════════════════════════════════════════════════════════
   Agent definitions — Cetus only
   ═════════════════════════════════════════════════════════ */

export const agents: Agent[] = [
  {
    id: "cetus-yield-agent",
    name: "Cetus Yield Agent (Template)",
    description: "Reference Cetus CLMM yield agent template. Deposits SUI/USDC into a Cetus Protocol pool on Sui and earns a share of trading fees. Monitors price and automatically repositions when the market drifts outside the earning zone. Transactions sign through WaaP.",
    email: "webmaster+cetus-yield-agent@holonym.id",
    chain: "Sui",
    network: "mainnet",
