...
import type { Agent, BalanceSnapshot, AgentEvent, PaymentScheduleItem, PaymentEvent, PaymentStats } from "@/lib/types";
...
export default function AgentDashboard() {
  ...
  const { agent, balanceHistory, events, schedules, payments, paymentStats } = data;
  ...
  return (
    <div className="container">
      ...
      <div className="grid grid-4" style={{ marginBottom: "var(--space-4xl)" }}>
        ...
        <StatCard label="Payments Sent" value={String(paymentStats.totalPaymentsSent)} />
        <StatCard label="Active Schedules" value={String(paymentStats.activeSchedules)} />
      </div>
      ...
      {/* 3. Payment schedules + upcoming */}
      <div className="grid grid-2" style={{ marginBottom: "var(--space-4xl)" }}>
        <PaymentSchedule schedules={schedules} />
        <UpcomingPayments schedules={schedules} />
      </div>
