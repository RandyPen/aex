...
import type { Agent, BalanceSnapshot, AgentEvent, TradeEvent, PositionData, PnLData, MarketData } from "@/lib/types";
...
export default function AgentDashboard() {
  ...
  const { agent, balanceHistory, events, trades, positions, pnl, watchedMarkets } = data;
  ...
  function getAgentHealthStatus(): { status: "trading" | "scanning" | "idle" | "stopped" } {
    ...
    for (const e of events) {
      ...
      if (e.type === "market_scan") return { status: "scanning" };
    }
