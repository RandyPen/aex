...
const statusConfig = {
  trading: {
    ...
    description: "The agent is placing trades based on high-confidence LLM analysis results.",
  },
  scanning: {
    label: "Analyzing markets",
    color: "var(--color-blue-50)",
    bg: "var(--color-blue-5)",
    description: "The LLM is reasoning about market questions. No trades being placed right now.",
  },
  idle: {
    label: "Idle",
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column" as const, justifyContent: "space-between" }}>
          <div>
            ...
            <p style={{
              ...
              This agent uses large language model reasoning to analyze {agent.protocol} prediction
              markets on {agent.chain}. It evaluates market questions against news, fundamentals,
              and chain-of-thought reasoning, then places trades only when LLM confidence
              exceeds the configured threshold. Positions are managed with automated stop-losses.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ color: "var(--color-text-80)" }}>LLM identifies mispriced markets, buys undervalued outcome shares</div>
            </div>
            <div>
