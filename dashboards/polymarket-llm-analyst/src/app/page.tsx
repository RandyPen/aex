    ...
    <div className="container" style={{ paddingTop: "var(--space-6xl)", paddingBottom: "var(--space-10xl)" }}>
      <header style={{ marginBottom: "var(--space-6xl)" }}>
        ...
        <p style={{ color: "var(--color-text-40)", fontSize: "var(--font-size-text-md)", maxWidth: "640px", lineHeight: 1.55 }}>
          Polymarket LLM Analyst agents operated by Holonym Foundation.
          Each agent uses large language model reasoning to analyze prediction markets,
          evaluate market questions against news and fundamentals, and trade when confidence exceeds threshold.
        </p>
      </header>
